  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        <button className="icon-button" type="button" aria-label="风险说明">
          <ShieldAlert size={19} />
        </button>
      </header>
...
function DiscoverView({
  ...
  const focusStocks = [...marketStocks]
    .sort((a, b) => {
    ...
    .slice(0, 4)
  const tickerStocks = focusStocks.length ? [...focusStocks, ...focusStocks] : []
      ...
      <section className="market-hero">
        <div className="market-hero__focus" aria-label="今日值得关注股票">
          ...
          <div className="market-board-status" aria-hidden="true">
            <span>LIVE</span>
            <b>按日涨幅、月趋势和研究评分综合排序</b>
          </div>
          <div className="focus-ticker">
          ...
          <small>点击股票进入分析，滚动内容为演示行情监看效果</small>
        </div>
      </section>
