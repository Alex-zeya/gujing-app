...
当前首版 App 以手机号验证码作为可用登录入口，用于保存用户持仓、观察池、提醒规则和风险偏好：
...
微信登录还需要 iOS 原生层接入微信 OpenSDK；Apple 登录需要正式 Apple Developer Program 和 Sign in with Apple 能力。
